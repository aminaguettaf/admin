  ...
  return (
    <div className='sidebar'>
      <ul className='pt-4'>
        ...
        <li><Link to='/categories' className='p-3 d-inline-block'><i className="fa-solid fa-table-columns me-2 fa-fw"></i><span>Categories</span></Link></li>
        <li><Link to='/create-admin' className='p-3 d-inline-block'><i className="fa-solid fa-user me-2 fa-fw"></i><span>Create Admin</span></Link></li>
